...
- キャンセル期間
    ...
    - キャンセルキーとしてInputEventの.delete, .control_g, .escapeを受けつけ、最後に実施した部首変換を元に戻す
...
- 交ぜ書き候補MRU学習を利用するかしないかを設定可能とする(デフォルト値は利用しない)
...
- 交ぜ書き候補MRU学習で、同じキーに対する異なる学習結果は、新しいもので上書きする
